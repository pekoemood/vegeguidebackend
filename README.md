...
**VegeGuide**は、忙しい社会人が「健康的な食生活を始めたいけれど、何を買えばいいのか・どう作ればいいのか分からない」
という悩みを解消するWebサービスです。<br>
旬の野菜を中心に、**選ぶ・作る・管理する**のすべてをサポート。  
...
私自身が30歳を迎え、健康的な食生活を意識し始めたとき、  
「どの野菜を選べばいいのか」「どう調理すればいいのか」が分からず、迷うことが多々ありました。
気づけばいつも同じような野菜ばかり選び、同じ料理を繰り返す日々。
忙しい社会人生活の中で、食材選びや調理のハードルの高さを実感したことが、このサービスを作るきっかけです。

- スーパーで野菜を見ても「どの野菜が旬なのか」「どう調理すればいいのか」が分からない 
- 野菜を買っても使い切れず、腐らせてしまう  
- 健康的な食生活を心がけたいが、レシピを考えるのが面倒  
- 食材の栄養価や保存方法など、基本的な知識がなく迷いを感じる  

こうした課題を解決し、「迷わず・ムダなく・健康的に」食生活を楽しめるよう、  
野菜選びから食材管理までをサポートするWebサービスを開発しました。
...
|登録したレシピの材料情報・調理手順を確認できます。<br>また、レシピ情報から食材の買い物リストを作成できます。|
